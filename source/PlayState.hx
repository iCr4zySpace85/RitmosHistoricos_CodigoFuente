...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Malísimo', 0.2], // De 0% a 19%
		['Horrible', 0.4], // De 20% a 39%
		['Malo', 0.5], // De 40% a 49%
		['Uf...', 0.6], // De 50% a 59%
		['Meh', 0.69], // De 60% a 68%
		['Nice', 0.7], // 69% (es popular dejar este como está en español también)
		['Bueno', 0.8], // De 70% a 79%
		['Genial', 0.9], // De 80% a 89%
		['¡Increíble!', 1], // De 90% a 99%
		['¡¡Histórico!!', 1] // Perfecto siempre es "1"
	];
