...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		title = 'Visuales e Interfaz';
		rpcTitle = 'Visuals & UI Settings Menu'; //for Discord Rich Presence

		var option:Option = new Option('Salpicaduras de Notas',
			"Si está desmarcado, golpear notas \"¡Sick!\" no mostrará partículas.",
			'noteSplashes',
			'bool',
			true);
		addOption(option);
		...
		var option:Option = new Option('Contador de FPS',
			'Si está desmarcado, oculta el contador de FPS.',
			'showFPS',
			'bool',
			true);
		addOption(option);
